...
class CreatePurchaseOrderPage extends Component {
    ...
    handleChangeItems(e, index) {
        const {catalogNumbers, quantities, itemsCost, details} = this.state;
        if (e.target.name === 'cat') {
            catalogNumbers[index] = e.target.value;
            this.setState({catalogNumbers});
        } else if (e.target.name === 'quantity') {
            quantities[index] = e.target.value;
            this.setState({quantities});
        } else if (e.target.name === 'cost') {
            itemsCost[index] = e.target.value;
            this.setState({itemsCost});
    ...
    handleSubmitTask = async () => {
        ...
        const {
            ...
            catalogNumbers, quantities, itemsCost, details
        } = this.state;
